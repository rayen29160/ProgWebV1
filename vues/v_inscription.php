<html>
	...
	<body>
		...
		<select id="test" name="listeMarques" onChange="changeImage();">			
			<option style="background:url('images/Marlboro.PNG') no-repeat; width:250px; height:100px;"></option>
			<option style="background:url('images/LuckyStrike.PNG') no-repeat; width:250px; height:100px;"></option>			
			<option style="background:url('images/Camel.PNG') no-repeat; width:250px; height:100px;"></option>
